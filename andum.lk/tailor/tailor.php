...
<div class="container-box">
  ...
  if ($result) {
    ...
    // get tailors dress
    $d_sql="SELECT * FROM dress_showcase WHERE t_nic='$selected_t_nic' ORDER BY dress_id DESC ";
  ...
  ?>
    ...
    <div class="row">
      ...
      <div class="col-3">
        <div class="card-item">
          <div class="card-img">
          <a href=""><img src="/ucsc_2202_07/andum.lk/tailor/products/<?php echo $d_row["image"]; ?> " alt="Avatar" style="width:100%"></a>
