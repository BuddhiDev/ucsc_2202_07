      ...
      <div class="customer-cover">
        ...
        <div class="col-3">
          <form method="get" action="hire_fashion_designer.php">
            ...
            <div class="card-item">
              <div class="card-img">
                <a href="fd.php?fd_nic=<?php echo $row["nic"] ?>"><img src="/ucsc_2202_07/andum.lk/fashion_designer/profile_pictures/<?php echo $row["image"]; ?>" alt="Ava" style="width:100%" class="proDisp"></a>    
              </div>
              <div class="card-content">
