...
<div class="row">
<h2>Sponsored Fashion Designers</h2>
</div>
              ...
              <form method="get" action="hire_fashion_designer.php" class="fd-showcase">
                ...
                <div class="fd-card-item">
                  <div class="fd-card-img">               
                    <a href="hire_fashion_designer.php?f_id=<?php echo $u_row["nic"] ?>"><img src="/ucsc_2202_07/andum.lk/fashion_designer/profile_pictures/<?php echo $u_row["image"]; ?>" alt="Avatar" style="width:100%" class="proDisp"></a>
                  </div>
