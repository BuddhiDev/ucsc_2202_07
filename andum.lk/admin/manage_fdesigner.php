  ...
  <div class="admin-container">
      <div class="admin-row">
        <div class="admin-search-container">
            <form method="post" action = "search_fd.php">
              <div class="form-field-inline">
                <input type="text" class="field-value-inline" name="q" placeholder="Search by fashion designer name..">
      ...
      <div class="admin-table">
        <table>
          ...
          <tr>
            ...
            <td>
              <div>
              <a href="manage_fdesigner.php?d_fnic=<?php echo $row["nic"]?>"><button class="admin-suspend-button">Suspend</button></a>
              </div>
            </td>
